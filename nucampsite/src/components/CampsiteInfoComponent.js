            ...
            <ModalBody>
                <LocalForm onSubmit={values =>this.handleSubmit(values)}>
                    <div className="form-group">
                        <Label htmlForm="rating" md={2}>Rating</Label>
                    ...
                    <div className="form-group">
                        <Label htmlFor="author" md={2}>Comment</Label>
                            <Control.textarea rows={6}  className="form-control" model=".text" name="text" id="text"/>                      
                    </div>
